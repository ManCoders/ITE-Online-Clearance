        ...
        <div class="dashboard-container">
            ...
            <div class="card">
                ...
                <form action="" method="post">
                    ...
                    <input type="text" name="course" style="display: none;" />
                    <script>
                    ...
                    <input type="text" name="department" style="display: none;" />
                    <script>
                    ...
                    <input type="text" name="sy" style="display: none;" />
                    <script>
                        document.querySelector('select[name="sy"]').addEventListener('change', function () {
                            if (this.value === 'other') {

                ...
                $(document).ready(function () {
                    ...
                    if (student_id !== "") {
                        $.ajax({
                            ...
                            success: function (response) {
                                $('#program').html("<option value=''>Select Program Title</option>" +
                                    response);
                        ...
                        if (semester !== "") {
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    $('#subject_name, #teacher').prop("disabled", true).html(
                                        "<option value=''>Select</option>"
                                    ); // Reset dependent dropdowns
                                }
                            });
                        } else {
                            $('#subject_code').prop("disabled", true).html(
                                '<option value="">Select Subject Code</option>');
                        }
                    });
                    ...
                    $('#subject_code').change(function () {
                        ...
                        if (subjectCode !== "") {
                            ...
                            $('#subject_name').prop("disabled", true).html(
                                '<option value="">Select Subject Name</option>');
                        }
                    });
                    ...
                    $('#subject_name, #subject_code').change(function () {
                        ...
                        if (subject_name !== "" || subject_code !== "") {
                            ...
                            $('#teacher').prop("disabled", true).html(
                                '<option value="">Select Assigned Teacher</option>');
                        }
